...
namespace ExamenP1JoseSanchez.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(ExamenP1JoseSanchezContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCarrera,NombreCarrera,Campus,NumSemestre")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCarrera,NombreCarrera,Campus,NumSemestre")] Carrera carrera)
        {
